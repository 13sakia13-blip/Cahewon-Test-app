...
export const getPopulatedCategories = async (): Promise<Category[]> => {
  // First, get all unique category_ids from the questions table
  ...
  // Then, fetch the categories that match these IDs
